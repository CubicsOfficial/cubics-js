...
export default {
     ...
     */
    async read({type, key, sort=null, sortValue=null, fields=null, preview=null, fetch=null}) {
     ...
     */
    async list({type, keys, sort=null, sortValues=null, fields=null, preview=null, fetch=null}) {
        if (!['allowance', 'balance', 'candle', 'claim', 'object', 'pool', 'statistic', 'token', 'transaction', 'transfer', 'wallet'].includes(type)) throw Error('type:invalid')
     ...
     */
    async scan({type, index, indexValue, sort=null, sortValue=null, keyValue=null, operator=null, asc=false, limit=null, preview=null, extend=null, fetch=null}) {
        if (!['allowance', 'balance', 'candle', 'claim', 'object', 'pool', 'statistic', 'token', 'transaction', 'transfer', 'wallet'].includes(type)) throw Error('type:invalid')
